...
<?php include_once "includes/auth/signup_auth.php";  ?>
                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            <h5 class="text-primary">Please Signup</h5>
                                            ...
                                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" >
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group auth-pass-inputgroup">
                                                        <input type="password" name="password1" required class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group auth-pass-inputgroup">
                                                        <input type="password" name="password2" required class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon">
                                                        <button class="btn btn-light " type="button" id="password-addon"><i class="mdi mdi-eye-outline"></i></button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-2 d-grid">
                                                    <button class="btn btn-primary  waves-effect waves-light" name="signup_submit" type="submit">Signup</button>
                                                </div>
                    
                                                
                                                </form>
                                            <div class="mt-2 text-center">
                                                <p>Already have an account ? <a href="login.php" class="fw-medium text-primary"> Login now </a> </p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> KunBlog. Crafted with <i class="mdi mdi-heart text-danger"></i> by KunmiFab</p>
                                    </div>
                                </div>
