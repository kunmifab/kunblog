<div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <h4 class="card-title mb-4">Add Profile Details</h4>
                                            ...
                                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" required name="admin_fullname">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" required name="admin_mobile">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" placeholder="e.g Lagos, Nigeria" class="form-control" name="admin_location">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" name="admin_info"></textarea>
                                                        </div>
                                                    </div>
                                                   
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <label for="formrow-email-input" class="form-label">Admin Image</label>
                                                ...
                                                <div>
                                                    <button type="submit" class="btn btn-primary w-md" name="profile_addbtn">Add Details</button>
                                                </div>
                                            </form>
                                        </div>
